...
ViewModel.prototype.id = 'campaignlistcontainerrunning';
ViewModel.prototype.children = [
    'runningcampaignimagelist' // Image List
    ,'imagestatisticsrunning' // Image Statistics
];

exports.register = function () {
    ko.components.register('c-campaignlistcontainerrunning', {
        viewModel: {
