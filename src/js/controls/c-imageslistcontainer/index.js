...
ViewModel.prototype.id = 'imageslistcontainer';
ViewModel.prototype.children = [
    'campagnimageslist' // Campaign Images
    ,'campaignimagedetails' // Image Details
];

exports.register = function () {
    ko.components.register('c-imageslistcontainer', {
        viewModel: {
