...
ViewModel.prototype.id = 'campaignlistcontainer';
ViewModel.prototype.children = [
    'campaignlist' // User Campaigns
    ,'executionstatelist' // Execution State
];

exports.register = function () {
    ko.components.register('c-campaignlistcontainer', {
        viewModel: {
