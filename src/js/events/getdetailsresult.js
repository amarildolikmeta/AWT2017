...
exports.createEvent = function () { // add "options" parameter if needed
    return function (context) {
        ...
        if (!context.vms['modifycampaignformcontainer']) {
            context.vms['campaigncontainer'].active('modifycampaignformcontainer');
        }
        context.vms['modifycampaignformcontainer'].init();
    };
};
